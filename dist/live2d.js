...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LAppLive2DManager; });
/* harmony import */ var _lib_Live2DFramework_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/Live2DFramework.js */ "./src/lib/Live2DFramework.js");
...
/* harmony import */ var _PlatformManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PlatformManager */ "./src/PlatformManager.js");
/* harmony import */ var _LAppModel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LAppModel */ "./src/LAppModel.js");
/* harmony import */ var _LAppDefine__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./LAppDefine */ "./src/LAppDefine.js");
/* harmony import */ var _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_LAppDefine__WEBPACK_IMPORTED_MODULE_3__);
...
LAppLive2DManager.prototype.createModel = function () {
  ...
  var model = new _LAppModel__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
LAppLive2DManager.prototype.maxScaleEvent = function () {
  if (_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.DEBUG_LOG)
    console.log("Max scale event.");
  for (var i = 0; i < this.models.length; i++) {
    this.models[i].startRandomMotion(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.MOTION_GROUP_PINCH_IN,
      _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.PRIORITY_NORMAL);
  }
}
...
LAppLive2DManager.prototype.minScaleEvent = function () {
  ...
  for (var i = 0; i < this.models.length; i++) {
    this.models[i].startRandomMotion(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.MOTION_GROUP_PINCH_OUT,
      _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.PRIORITY_NORMAL);
  }
}
...
LAppLive2DManager.prototype.tapEvent = function (x, y) {
  ...
  for (var i = 0; i < this.models.length; i++) {
    ...
    if (this.models[i].hitTest(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.HIT_AREA_HEAD, x, y)) {

      if (_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.DEBUG_LOG)
        console.log("Tap face.");

      this.models[i].setRandomExpression();
    }else if (this.models[i].hitTest(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.HIT_AREA_BODY, x, y)) {

      if (_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.DEBUG_LOG)
        console.log("Tap body." + " models[" + i + "]");

      this.models[i].startRandomMotion(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.MOTION_GROUP_TAP_BODY,
        _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.PRIORITY_NORMAL);
      ...
      if (_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.DEBUG_LOG)
        ...
        this.models[i].startRandomMotion(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.MOTION_GROUP_FLICK_HEAD,
          _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.PRIORITY_NORMAL);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LAppModel; });
/* harmony import */ var _lib_Live2DFramework__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/Live2DFramework */ "./src/lib/Live2DFramework.js");
...
/* harmony import */ var _lib_ModelSettingJson__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/ModelSettingJson */ "./src/lib/ModelSettingJson.js");
/* harmony import */ var _LAppDefine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LAppDefine */ "./src/LAppDefine.js");
...
/* harmony import */ var _lib_MatrixStack__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/MatrixStack */ "./src/lib/MatrixStack.js");
...
LAppModel.prototype = new _lib_Live2DFramework__WEBPACK_IMPORTED_MODULE_0__["L2DBaseModel"]();
                    ...
                    if( thisRef.isTexLoaded ) {
                        ...
                        if (thisRef.modelSetting.getHitAreasCustom() != null)
                        {
                            ...
                            if (hit_areas_custom["head_x"] != null)
                                _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_head_x = hit_areas_custom["head_x"];
                            if (hit_areas_custom["head_y"] != null)
                                _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_head_y = hit_areas_custom["head_y"];
                            if (hit_areas_custom["body_x"] != null)
                                _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_body_x = hit_areas_custom["body_x"];
                            if (hit_areas_custom["body_y"] != null)
                                _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_body_y = hit_areas_custom["body_y"];
                }
                        ...
                        thisRef.preloadMotionGroup(_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.MOTION_GROUP_IDLE);
                        thisRef.preloadMotionGroup(_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.MOTION_GROUP_SLEEPY);
...
LAppModel.prototype.update = function()
{
    ...
    {
        if (_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.DEBUG_LOG) console.error("Failed to update.");
    ...
    if (this.mainMotionManager.isFinished())
    {
        ...
        if(Sleepy === '1') {
            this.startRandomMotion(_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.MOTION_GROUP_SLEEPY, _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.PRIORITY_SLEEPY);
        }else {
            this.startRandomMotion(_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.MOTION_GROUP_IDLE, _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.PRIORITY_IDLE);
        }
    }
...
LAppModel.prototype.startMotion = function(name, no, priority)
{
    ...
    {
        if (_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.DEBUG_LOG)
            console.error("Failed to motion.");
        return;
    }

    if (priority == _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.PRIORITY_FORCE) 
    {
...
{
    if (type == 'head'){
        return this.hitTestSimpleCustom(_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_head_x, _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_head_y, testX, testY);
    }else if (type == 'body'){
        return this.hitTestSimpleCustom(_LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_body_x, _LAppDefine__WEBPACK_IMPORTED_MODULE_2___default.a.hit_areas_custom_body_y, testX, testY);
    }else{
        return false; 
    }
}
...
/* harmony import */ var _webglcontext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./webglcontext */ "./src/webglcontext.js");
/**
 *
...
/* harmony import */ var _Live2DFramework__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Live2DFramework */ "./src/lib/Live2DFramework.js");
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! (webpack)/buildin/system.js */ "C:\\Users\\jwf\\AppData\\Roaming\\npm\\node_modules\\webpack\\buildin\\system.js")))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_live2d_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/live2d.min */ "./src/lib/live2d.min.js");
/* harmony import */ var _lib_live2d_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_lib_live2d_min__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _lib_Live2DFramework__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/Live2DFramework */ "./src/lib/Live2DFramework.js");
...
/* harmony import */ var _LAppLive2DManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LAppLive2DManager */ "./src/LAppLive2DManager.js");
/* harmony import */ var _LAppDefine__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./LAppDefine */ "./src/LAppDefine.js");
/* harmony import */ var _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_LAppDefine__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lib_MatrixStack__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib/MatrixStack */ "./src/lib/MatrixStack.js");
...
/* harmony import */ var _webglcontext__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./webglcontext */ "./src/webglcontext.js");
...
const live2DMgr = new _LAppLive2DManager__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
function init(modelurl) {
  ...
  let left = _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_LOGICAL_LEFT;
  let right = _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_LOGICAL_RIGHT;
  let bottom = -ratio;
  let top = ratio;
  ...
  viewMatrix.setMaxScreenRect(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_LOGICAL_MAX_LEFT,
    _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_LOGICAL_MAX_RIGHT,
    _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_LOGICAL_MAX_BOTTOM,
    _LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_LOGICAL_MAX_TOP);

  viewMatrix.setMaxScale(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_MAX_SCALE);
  viewMatrix.setMinScale(_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.VIEW_MIN_SCALE);
...
function modelTurnHead(event)
{
    ...
    if (_LAppDefine__WEBPACK_IMPORTED_MODULE_3___default.a.DEBUG_MOUSE_LOG)
